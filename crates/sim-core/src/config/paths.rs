...
pub const PARAMETER_PATHS: &[&str] = &[
    ...
    "starter.supply_resistance_ohm",
    "starter.rotor_inertia_kg_m2",
    "starter.drive_stiffness_nm_per_rad",
    "starter.drive_damping_nm_per_rad_s",
    "starter.commutator_segments",
    ...
    "audio.body_gain",
    "audio.body_pressure_rate_gain_s",
    "audio.body_pressure_weights",
    "audio.body_modes",
    "audio.starter_gain",
    "audio.starter_rotor_gain",
    "audio.starter_modes",
    "rated.max_power_w",
    "rated.max_power_hp",
    "rated.max_torque_nm",
